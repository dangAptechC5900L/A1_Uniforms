	...
	var dzSparkLine = function () {
		...
		var barChart2 = function () {
			if (jQuery('#barChart_2').length > 0) {
				// Fetch data from index.php using AJAX
				jQuery.ajax({
					url: 'index.php', // Đường dẫn tới file xử lý logic (index.php)
					...
					success: function (data) {
						...
						var config = {
							...
							data: {
								defaultFontFamily: 'Poppins',
								labels: labels, // Sử dụng tên tháng từ dữ liệu trả về
								datasets: [
									{
										label: "My First dataset",
										data: Object.values(data), // Sử dụng số liệu từ dữ liệu trả về
